<template>
  <PageWrapper contentBackground title="按钮权限控制" contentClass="p-4">
    ...
    <Authority :value="'authority:menu:add'">
      <a-button type="primary" class="mx-4"> 拥有code ['authority:menu:add']权限可见 </a-button>
    </Authority>
    ...
    <a-button v-if="hasPermission('authority:menu:add')" type="primary" class="mx-4">
      拥有code ['authority:menu:add']权限可见
    </a-button>
    ...
    <a-button v-auth="'authority:menu:add'" type="primary" class="mx-4">
      拥有code ['authority:menu:add']权限可见
    </a-button>
