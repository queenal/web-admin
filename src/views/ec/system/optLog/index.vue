...
<script lang="ts">
  ...
  import { page, remove, clear } from '/@/api/ec/system/optLog';
  import { columns, searchFormSchema } from './optLog.data';
  import { clearList } from '../loginLog/loginLog.data';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('ec.system.optLog.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
