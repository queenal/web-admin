...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/ec/system/dictionaryItem';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      onMounted(() => {
        ...
        dictType.value = params?.type as string;
        dictLabel.value = query?.label as string;
        reload();
      });
