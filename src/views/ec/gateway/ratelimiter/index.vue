...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/ec/gateway/rateLimiter';
  import { columns, searchFormSchema } from './rateLimiter.data';
  import EditModal from './Edit.vue';

  export default defineComponent({
    name: 'RateLimiterManagement',
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('ec.gateway.rateLimiter.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
