  ...
  <PageWrapper dense contentFullHeight>
    <BasicTable @register="registerTable">
      <template #toolbar>
        ...
        <a-button type="primary" @click="handleAdd">发送短信</a-button>
      </template>
...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/ec/resources/smsTask';
  import { columns, searchFormSchema } from './smsTask.data';

  export default defineComponent({
    name: 'SmsTaskManagement',
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('ec.resources.smsTask.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
