...
<script lang="ts">
  ...
  import { Api, save, update } from '/@/api/ec/resources/smsTemplate';
  import { getValidateRules } from '/@/api/ec/common/formValidateService';
  import { customFormSchemaRules, editFormSchema } from './smsTemplate.data';
  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      const [registerDrawer, { setDrawerProps, closeDrawer }] = useDrawerInner(async (data) => {
        ...
        record.providerType = data?.record?.providerType?.code;
