<template>
  <PageWrapper dense contentFullHeight>
    <BasicTable
      ...
      titleHelpMessage="具体参数介绍请参考： https://www.kancloud.cn/zuihou/zuihou-admin-cloud/2074569"
    >
      <template #toolbar>
...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/ec/resources/smsTemplate';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('ec.resources.smsTemplate.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
