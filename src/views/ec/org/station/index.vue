<template>
  <PageWrapper dense contentFullHeight>
    ...
    <ImpExcelModel
      ...
      :api="importFile"
      :templateHref="templateUrl.station"
    />
  </PageWrapper>
</template>
<script lang="ts">
  ...
  import { page, remove, importFile, exportFile, exportPreview } from '/@/api/ec/org/station';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys, getForm }] = useTable({
        title: t('ec.org.station.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
      ...
      function handleExport() {
        ...
        params.extra = {
          ...{
            fileName: t('ec.org.station.table.title'),
          },
          ...params?.extra,
        };
        params.size = 20000;
